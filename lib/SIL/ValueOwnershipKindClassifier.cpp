...
CONSTANT_OWNERSHIP_BUILTIN(Trivial, AutoDiffGetOriginalFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, AutoDiffGetJVPFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, AutoDiffGetVJPFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, AutoDiffGetPrimalFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, AutoDiffGetAdjointFunction)
