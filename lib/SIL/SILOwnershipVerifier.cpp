...
CONSTANT_OWNERSHIP_BUILTIN(Trivial, MustBeLive, AutoDiffGetOriginalFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, MustBeLive, AutoDiffGetJVPFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, MustBeLive, AutoDiffGetVJPFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, MustBeLive, AutoDiffGetPrimalFunction)
CONSTANT_OWNERSHIP_BUILTIN(Trivial, MustBeLive, AutoDiffGetAdjointFunction)
