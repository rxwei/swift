...
CONSTANT_OWNERSHIP_BUILTIN(Guaranteed, NonLifetimeEnding, AutoDiffProjectSubcontextBuffer)
CONSTANT_OWNERSHIP_BUILTIN(Owned, NonLifetimeEnding, AutoDiffGetPreviousSubcontext)
