...
CONSTANT_OWNERSHIP_BUILTIN(None, AutoDiffTapeManagerCreate)
CONSTANT_OWNERSHIP_BUILTIN(None, AutoDiffTapeManagerDestroy)
CONSTANT_OWNERSHIP_BUILTIN(None, AutoDiffTapeCreate)
CONSTANT_OWNERSHIP_BUILTIN(None, AutoDiffTapeAllocate)
CONSTANT_OWNERSHIP_BUILTIN(None, AutoDiffTapePop)
